...
//   )
  return (
    <div className="">
    <section class="pt-16 sm:pt-20 md:pt-24 lg:pt-28 bg-white py-8 antialiased dark:bg-black md:py-12">
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="pt-6">
          ...
          <div class="mt-4 flex items-center justify-between gap-4">
            ...
            <button type="button" class="inline-flex items-center rounded-lg  px-5 py-2.5 text-sm font-medium dark:text-white text-black  dark:hover:bg-[#998200] hover:bg-[#900C3F] focus:outline-none focus:ring-4  focus:ring-primary-300   dark:focus:ring-primary-800">
